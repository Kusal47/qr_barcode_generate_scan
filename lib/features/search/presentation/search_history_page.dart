                                        ...
                                        itemBuilder: (_, index) {
                                          ...
                                          if (dataList.wifi != null) {
                                            return WifiDetailsWidget(
                                              ...
                                              yesPressed: () {
                                                shc.hc.deleteQRData(ssid: dataList.wifi!.ssid!);
                                                Get.back();
                                              },
                                            );
                                            ...
                                            return UrlDetailsWidget(
                                              dataList: dataList,
                                              onYesPressed: () {
                                                shc.hc.deleteQRData(url: dataList.url!.url!);
                                                Get.back();
                                              },
                                            );
                                            ...
                                            return EmailDetailsWidget(
                                              dataList: dataList,
                                              onYesPressed: () {
                                                shc.hc.deleteQRData(email: dataList.email!.address);
                                                Get.back();
                                              },
                                            );
                                            ...
                                            return SmsDetailsWidget(
                                              dataList: dataList,
                                              onYesPressed: () {
                                                shc.hc.deleteQRData(sms: dataList.sms!.number);
                                                Get.back();
                                              },
                                            );
                                            ...
                                            return PhoneDetailsWidget(
                                              dataList: dataList,
                                              onYesPressed: () {
                                                shc.hc.deleteQRData(phone: dataList.phone!.number);
                                                Get.back();
                                              },
                                            );
                                            ...
                                            return GeoDetailsWidget(
                                              dataList: dataList,
                                              onYesPressed: () {
                                                shc.hc.deleteQRData(geo: dataList.geo!.latitude);
                                                Get.back();
                                              },
                                            );
                                            ...
                                            return BarcodeDetailsWidget(
                                              dataList: dataList,
                                              onYesPressed: () {
                                                shc.hc.deleteQRData(barcode: dataList.displayValue);
                                                Get.back();
                                              },
                                            );
                                          } else {
